...
class ClassList {
  List<Class> allClasses = [
    ...
    Class(
      ...
      affinities: [Affinities.oneHandSharp, Affinities.twoHandShard], 
    ...
    Class(
      ...
      affinities: [Affinities.oneHandSharp], 
    ...
    Class(
      ...
      affinities: [Affinities.oneHandSharp, Affinities.throwable], 
    ...
    Class(
      ...
      affinities: [Affinities.throwable, Affinities.oneHandSharp, Affinities.twoHandShard], 
    ...
    Class(
      ...
      affinities: [Affinities.firearm, Affinities.oneHandSharp],
    ...
    Class(
      ...
      affinities: [Affinities.twoHandShard], 
  ...
  List<Class> getClassListByIds(int first, int last) {
    List<Class> res = [];
