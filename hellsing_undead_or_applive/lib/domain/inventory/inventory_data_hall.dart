...
class SupportObjectList {
  List<SupportObject> allSupportObject = [
    ...
    SupportObject(
      ...
      legend: "Des fioles, plein de fioles ! Remplies de liquides bizarres ! J'aime les fioles.", 
    ...
    SupportObject(
      ...
      description: "Set d'outils et de  matières premières nécessaire à un Artificier pour créer des Bombes. Limité aux Artificiers.", 
      price: 80, 
      stockage: Stockage.weapon, 
      size: 1,
    ),
    ...
    SupportObject(
      id: 8, 
      name: "Lanterne", 
      legend: "Le problème avec la nuit, c'est qu'on n'y voit souvent rien", 
      description: "Lanterne à huile, éclaire autour du porteur avec une flamme protégée par du verre. Libère de l'huile Inflammable si brisée.", 
      price: 50, 
      stockage: Stockage.bag, 
      size: 1,
    ),
